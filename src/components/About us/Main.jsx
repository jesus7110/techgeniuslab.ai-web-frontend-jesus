...
const AboutUsSection = () => {
  return (
    <div className="relative overflow-hidden bg-white py-10 w-4/5 mx-auto">
      <div className="pb-80 pt-16 sm:pb-12 sm:pt-24 lg:pb-2 lg:pt-40 flex justify-evenly items-center">

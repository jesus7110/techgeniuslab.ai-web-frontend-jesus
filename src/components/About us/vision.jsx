...
const Mission = () => {
  return (
    <div className="relative overflow-hidden bg-white py-10 w-4/7 mx-auto">
      <div className="pb-80 pt-6 sm:pb-40 sm:pt-12 lg:pb-8 lg:pt-10 flex justify-evenly items-center">
